...
class AudioManager {
    constructor() {
        this.sounds = {
            theme: new Audio('static/audio/theme-a.mp3'),
            rotate: new Audio('static/audio/rotate.mp3'),
            clear: new Audio('static/audio/clear.mp3'),
            drop: new Audio('static/audio/drop.mp3'),
